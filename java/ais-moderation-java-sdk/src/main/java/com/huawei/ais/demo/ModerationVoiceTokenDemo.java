 ...
 * 使用Token认证方式访问服务
 */
public class ModerationVoiceTokenDemo {
	 ...
	 * @throws IOException
	 */
	public static void requestModerationVoiceContentBase64(String token, String formFile) throws IOException {
		String url = ServiceAccessBuilder.getCurrentEndpoint(projectName)+"/v1.0/moderation/voice";
	...
	public static void main(String[] args) throws URISyntaxException, UnsupportedOperationException, IOException {
		...
		//运行图像内容检测服务
		requestModerationVoiceContentBase64(token, "data/moderation-voice.wav");
